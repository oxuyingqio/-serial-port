 ...
 *
 */
public class Di2B_Value extends Di {
	...
	public Integer getPrice1() {
		...
		return ByteUtils.byteArray2Int(ByteUtils.reverse(this.prototype.price1));
	}
	...
	public Integer getVolume1() {
		...
		return ByteUtils.byteArray2Int(ByteUtils.reverse(this.prototype.volume1));
	}
	...
	public Integer getPrice2() {
		...
		return ByteUtils.byteArray2Int(ByteUtils.reverse(this.prototype.price2));
	}
	...
	public Integer getVolume2() {
		...
		return ByteUtils.byteArray2Int(ByteUtils.reverse(this.prototype.volume2));
	}
	...
	public Integer getPrice3() {
		...
		return ByteUtils.byteArray2Int(ByteUtils.reverse(this.prototype.price3));
	}
	...
	public Date getDate() {
		...
		Short temp = ByteUtils.byteArray2Short(ByteUtils.reverse(this.prototype.date));

		GregorianCalendar gc = new GregorianCalendar();
		gc.set(Calendar.YEAR, (this.prototype.date[1] >> 1) + 2000);
		gc.set(Calendar.MONTH, temp >> 5 & 0x0F - 1);
		gc.set(Calendar.DAY_OF_MONTH, this.prototype.date[0] & 0x1F);
	...
	public static void main(String[] args) {
		...
		byte[] demo = new byte[] { 0x61, 0x23 };
		short s = ByteUtils.byteArray2Short(ByteUtils.reverse(demo));

		System.out.println(2000 + (demo[1] >> 1));
		System.out.println(s >> 5 & 0x0F);
		System.out.println(demo[0] & 0x1F);
	}
}