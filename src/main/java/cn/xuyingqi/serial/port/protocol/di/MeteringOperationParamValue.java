...
public class MeteringOperationParamValue extends Di {
	...
	public Long getMaxValue() {
		...
		return ByteUtils.byteArray2Long(this.prototype.maxValue);
	}
	...
	public Long getMinValue() {
		...
		return ByteUtils.byteArray2Long(this.prototype.minValue);
	}
	...
	public Integer getPrice() {
		...
		return ByteUtils.byteArray2Int(this.prototype.price);
	}
