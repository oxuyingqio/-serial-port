 ...
 *
 */
public class WakeUpTimeValue extends Di {
	...
	public String getStartTime() {
		...
		return ByteUtils.byte2Short(this.prototype.startTime[0]) + ByteUtils.byte2Short(this.prototype.startTime[1])
				+ ByteUtils.byte2Short(this.prototype.startTime[2]) + "";
	}
	...
	public String getEndTime() {
		...
		return ByteUtils.byte2Short(this.prototype.endTime[0]) + ByteUtils.byte2Short(this.prototype.endTime[1])
				+ ByteUtils.byte2Short(this.prototype.endTime[2]) + "";
	}
	...
	private class Prototype {
		 ...
		 * 唤醒开始时间默认长度
		 */
		private static final int START_TIME_LENGTH = 3;
		/**
		 * 唤醒结束时间默认长度
		 */
		private static final int END_TIME_LENGTH = 3;
